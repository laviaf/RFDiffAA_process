import sys, os
os.chdir('/home/ubuntu/RFAA/heme_binder_diffusion')
sys.path.append('/home/ubuntu/RFAA/heme_binder_diffusion')
...
# import lib.LigandMPNN.mpnn_api
from lib.LigandMPNN.mpnn_api import MPNNRunner
...
for N in range(args.nstruct):
    ...
    while len(filt_scores) == 0:
        ...
        inp.temperature = 0.2
        # inp.omit_AA = "CM"
        inp.bias_AA = {"H":-10.0,"C":-10.0,"M":-2.0}
        inp.batch_size = 5
